...
/// no interrumpir con ella en cada arranque — mismo patrón que
/// `sistema-diseno-almacenes`: no es un `ChangeNotifier`, es solo
...
class TourController {
  ...
  /// `main.dart` llama esto antes de `runApp` (mismo momento que
  /// `sembrarCasoEstudioSiVacio`) — evita que `main.dart` tenga que conocer
