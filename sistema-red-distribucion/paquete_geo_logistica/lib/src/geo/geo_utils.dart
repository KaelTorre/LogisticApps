...
/// Ángulo polar (en radianes) de un punto respecto a un origen.
double anguloPolar({
...
/// `/route/` (algoritmo estándar de Google, precisión 5) a una lista de
/// puntos consumible por `flutter_map`.
...
/// polyline ya decodificada) para dibujar flechas de dirección. La cantidad
/// de flechas escala con la longitud real de la ruta: ~1 cada
/// [intervaloKm] km, entre [minimo] y [maximo].
...
/// usando la proporción real de distancia de cada tramo
/// (`distanciasTramoMetros`, de `OsrmRouteResponse.tramos`) para ubicar
/// dónde "cortarla" dentro de la geometría combinada.
///
