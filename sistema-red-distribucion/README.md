...
**Fase 0, Fase 1 y Fase 2 completas.** Fases 3 a 9 pendientes.
...
- [ ] **Pendiente — Fase 3:** M1 (agregación de zonas de demanda), M2 (centro de gravedad, activa el botón diferido en Sitios candidatos) y `tool/verificar_limite_osrm.dart` (límite real de coordenadas por consulta, documentado en `docs/limites_osrm.md`).
