...
**Fase 0 — Paquete compartido y andamiaje: completa.** Fases 1 a 9 pendientes.
...
- [ ] **Pendiente — Fase 1:** las quince tablas de drift (sección 6 de `CLAUDE.md`), `CacheRuteoDrift`, modelos de dominio y repositorios.
