...
# (sistema_optimizacion_rutas) de forma headless bajo Xvfb.
#
...
APP_NAME="sistema_optimizacion_rutas"
BINARY="$APP_DIR/build/linux/x64/debug/bundle/$APP_NAME"

DISPLAY_NUM="${FLUTTER_DRIVER_DISPLAY:-99}"
XDISPLAY=":$DISPLAY_NUM"
STATE_DIR="${FLUTTER_DRIVER_STATE_DIR:-/tmp/flutter-run-driver}"
